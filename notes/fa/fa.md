...
* **Manager Feature**
    * Manager Alpha - We know some managers are good. For example, Carrick in 25/26 took United to top 4 after a horrible Amorim bear run. But to what extent does past manager perform carry over, from cross-league? Similar to transfer-in problem. 
