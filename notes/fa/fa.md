...
* **Style feature**
    ...
    * Counterattack vs Possession/Pressing - Matchups of City vs Spurs (GW12 24/25, 23-11-24, 4-0), United vs City (GW21 25/26, 17-01-26, 2-0) come to mind. Aggravation: made worse by an attacking minded midfield vs fast attackers **(quantifiable with FIFA/FC stats?)**
    ...
    * Short Backline vs Crossing/Set Piece Vulnerability - Can't think of an example for this. 
